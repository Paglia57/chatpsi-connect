...
/**
 * Calcula o DAS mensal com base na alíquota efetiva do Simples.
 * aliquotaEfetiva = (RBT12 × alíquotaNominal − dedução) / RBT12
 * DAS mensal = aliquotaEfetiva × faturamentoMensal
 */
