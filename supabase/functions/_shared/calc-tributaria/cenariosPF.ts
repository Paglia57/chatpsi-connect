// Espelho de src/lib/calc-tributaria/cenariosPF.ts — manter em sincronia.

import { CalcInput, CenarioPF } from './types.ts';
import {
...
import { calcularInssPF } from './inss.ts';
import { calcularIRPFMensal } from './irpf.ts';
