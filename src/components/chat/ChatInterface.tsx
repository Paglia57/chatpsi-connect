          ...
          <div className="flex items-center justify-end gap-1 sm:gap-2">
            ...
            {profile?.subscription_active ? (
              <Badge variant="secondary" className="bg-success/10 text-success border-success/20 text-xs">
                ...
                {isMobile ? "Ativa" : "Ativa"}
              </Badge>
            ) : (
              <Badge variant="secondary" className="bg-warning/10 text-warning border-warning/20 text-xs">
                <AlertCircle className="h-3 w-3 mr-1" />
                {isMobile ? "Inativa" : "Inativa"}
              </Badge>
            )}
                  ...
                  <Card className={`${
                    ...
                    <CardContent className="p-2 sm:p-3">
                     ...
                     {message.message_type === 'audio' && message.media_url ? (
                       ...
                       <p className="text-sm whitespace-pre-wrap break-words text-overflow-anywhere">
                         {message.content}
                       </p>
                     )}
       ...
       {showNewMessageIndicator && (
         <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-10">
           <Button
             ...
             className="animate-fade-in shadow-lg touch-target"
           >
      ...
      <div className="composer-container p-3 sm:p-4 flex-shrink-0">
        {canSendMessage ? (
          <div className="max-w-4xl mx-auto">
            {attachedFile && (
              <div className="mb-3 p-2 bg-muted rounded-md flex items-center gap-2 animate-fade-in">
            ...
            {recordingState === 'recording' && (
              <div className="mb-3 p-3 bg-destructive/10 border border-destructive/20 rounded-md animate-fade-in">
              ...
              <div className="flex gap-2">
                ...
                {isAssistantTyping && (
                  <Button 
                    ...
                    aria-label="Interromper e recarregar"
                  >
                    <RefreshCw className="h-4 w-4" />
                  </Button>
                )}
            ...
            <input 
              ref={fileInputRef} 
              type="file" 
              accept=".jpg,.jpeg,.png,.heic,.webp,audio/*,.mp3,.ogg,.wav,.m4a,video/*,.pdf,.doc,.docx" 
